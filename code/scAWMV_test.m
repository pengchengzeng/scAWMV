...
%load preprocessed data, RAGI socre matrix, and ground truth labels
...
%scAWMV algorithm. Note that the clustering results shown in this step is
%based on k++means.
...
%Use the V_centroid as the input for Louvain clustering. See the python
%file Louvain_scAWMV.ipynb.
